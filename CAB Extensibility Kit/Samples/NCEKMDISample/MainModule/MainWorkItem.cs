...
namespace MainModule {
    public class MainWorkItem : WorkItem {
        ...
        private UltraMdiTabWorkspace mdiWorkspace;
        ...
        public void Run(IWorkspace ExplorerBarWorkspace) {
            ...
            this.mdiWorkspace = (UltraMdiTabWorkspace)this.RootWorkItem.Workspaces["ultraMdiTabWorkspace1"];
        ...
        public void LoadTable(string db, string table) {
            ...
            if (!this.Items.Contains(db + " - " + table)) {
                ...
                UltraMdiTabSmartPartInfo smartPartInfo = new UltraMdiTabSmartPartInfo();
                smartPartInfo.Title = db + "-" + table;

                mdiWorkspace.Show(grid, smartPartInfo);
                ...
                mdiWorkspace.Show(this.Items.Get(db + " - " + table));
            }
        ...
        public void ToggleColumnVisibility(string key, bool hidden) {
            TableGridView grid = (TableGridView) mdiWorkspace.ActiveSmartPart;
