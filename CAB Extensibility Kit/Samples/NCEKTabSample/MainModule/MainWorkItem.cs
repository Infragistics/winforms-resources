...
namespace MainModule {
    public class MainWorkItem : WorkItem {
        ...
        private UltraTabWorkspace tabWorkspace;
        ...
        public void Run(IWorkspace ExplorerBarWorkspace) {
            ...
            this.tabWorkspace = (UltraTabWorkspace)this.RootWorkItem.Workspaces["ultraTabWorkspace1"];
        ...
        public void LoadTable(string db, string table) {
            ...
            if (!this.Items.Contains(db + " - " + table)) {
                ...
                UltraTabSmartPartInfo smartPartInfo = new UltraTabSmartPartInfo();
                smartPartInfo.Title = db + "-" + table;

                tabWorkspace.Show(grid, smartPartInfo);
                ...
                tabWorkspace.Show(this.Items.Get(db + " - " + table));
            }
        ...
        public void ToggleColumnVisibility(string key, bool hidden) {
            TableGridView grid = (TableGridView) tabWorkspace.ActiveSmartPart;
